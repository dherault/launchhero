...
function createProjectsRoutes() {
  ...
  router.get('/:projectId/users', async (request, response) => {
  ...
  router.post('/:projectId/invite', validate({ body: inviteSchema }), async (request, response) => {
    const projectId = request.params.projectId
  ...
  router.post('/accept-invitation', validate({ body: acceptInvitationSchema }), async (request, response) => {
