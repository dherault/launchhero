...
function Legal() {
  ...
  return (
    <>
      ...
      <p>
        The personal information we collect is stored and/or processed in France, or where we or our partners, affiliates, and third-party providers maintain facilities.
      </p>
      <p>
